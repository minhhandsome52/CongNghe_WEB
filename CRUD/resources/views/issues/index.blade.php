            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('issues.create') }}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>ADD</span></a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="urgency-{{ strtolower($issue->urgency) }}" style="font-weight:bold"  >
                                {{ $issue->urgency }}
                            </td>
                            <td class="status-{{ strtolower(str_replace(' ', '-', $issue->status)) }}" style="font-weight:bold">
                                {{ $issue->status }}
                            </td>
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('issues.destroy', $issue->id) }}" method="POST">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title">Delete Thesis</h4>
